      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <a
            ...
            onClick={(e) => triggerNeonConfetti(e.clientX, e.clientY)}
            className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-emerald-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-950/20 group flex items-start gap-4 hover:-translate-y-1"
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={(e) => triggerNeonConfetti(e.clientX, e.clientY)}
            className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-950/20 group flex items-start gap-4 hover:-translate-y-1"
          >
          ...
          {/* Card 3: Email with copy button & confetti */}
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 flex items-start justify-between gap-4 hover:-translate-y-1 transition-all">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-slate-700 transition-all duration-300 group flex items-start gap-4 hover:-translate-y-1"
          >
